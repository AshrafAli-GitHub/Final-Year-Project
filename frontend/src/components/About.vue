<template>
    <div class='container text-center'>
        ...
        <p class='text-info'>Welcome to our Flashcards App! As the developer of this app, I am excited to introduce you to a powerful learning tool that can help you ace your exams and achieve academic success.</p>

        <p class='text-info'>This app is the culmination of my final year project at the university, and I am proud to offer it to you as a user-friendly and intuitive study aid. With this app, you can create and customize your own digital flashcards, allowing you to review key concepts and facts anytime, anywhere.</p>
